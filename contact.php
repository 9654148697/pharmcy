...
<!-- Mirrored from html.rometheme.net/pharmed/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Sep 2025 19:56:50 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <main>
        ...
        <div class="section position-relative bg-attach-fixed overflow-hidden mx-auto rounded-4"
            style="background-image: url(image/img13.jpg); background-position: top; height: 70vh; max-width: 1770px;">
                ...
                <div class="row row-cols-xl-2 row-cols-1">
                        ...
                        <div class="d-flex flex-column gap-3 w-100 px-5 pe-5 bg-accent-color-3">
                            <div class="pe-5">
                                <div class="d-flex flex-column gap-3 bg-accent-primary p-4"
                                    ...
                                    <h3>Our Pharmacy & Healthcare Team is Here to Help</h3>
                                    <p>Whether you need prescription refills, medical advice, or personalized care, our
                                        expert team is dedicated to supporting your health and well-being.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col col-xl-5 mb-3 scrollanimation animated fadeInRight">
                        <div class="d-flex flex-column gap-3 h-100">
                            <img src="image/img16.jpg" class="img-fluid h-100 rounded-4" alt="">
        ...
        <div class="section">
            <div class="r-container position-relative">
                <div class="position-absolute bottom-0 end-0 d-flex flex-column gap-2 p-4 bg-accent-primary" style="border-top-left-radius: 20px;">
                    <h3>Our Location</h3>
                    <div class="d-flex flex-row align-items-center font-2 gap-3">
                        <i class="rtmicon rtmicon-location fs-4"></i>
                        <span>KLLG st, No.99, Pku City, ID 28289</span>
